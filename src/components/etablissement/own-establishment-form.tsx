...
export function OwnEstablishmentForm({
  establishment,
  action,
  error,
}: {
    ...
    <form action={action} className="flex flex-col gap-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <select name="type" required defaultValue={establishment.type} className={inputClass}>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input type="text" name="city" defaultValue={establishment.city ?? ""} className={inputClass} />
        </div>
        <div>
